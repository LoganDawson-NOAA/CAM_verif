...
for use_case in use_cases:
    ...
    if use_case == 'grid2grid_mrms':
        ...
        models = ['CONUSHREFX_PMMN','CONUSHREFX_PROB']
    elif use_case == 'surrogate_severe':
        vx_grid = 'G211'
        stat_analysis_conf = 'StatAnalysis_fcstSSPF_obsPPF_gatherByHour.conf'
        models = ['CONUSARW','CONUSARW2','CONUSFV3','CONUSHREF_PROB','CONUSHREFX_PROB','CONUSNEST','CONUSNMMB','FV3LAM','FV3LAMDA','FV3LAMX','HRRR']
    elif use_case == 'grid2obs':
        vx_grid = 'G104'
        ...
        models = ['AKHREFX_MEAN','CONUSHREFX_MEAN']
