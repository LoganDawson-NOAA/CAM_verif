...
/gpfs/dell2/emc/verification/save/Logan.Dawson/METplus-3.0-beta2/ush/master_metplus.py -c /gpfs/dell2/emc/verification/save/Logan.Dawson/CAM_verif/parm/metplus_config/METplus-3.0/ldawson_dell.conf /gpfs/dell2/emc/verification/save/Logan.Dawson/CAM_verif/parm/use_cases/METplus-3.0/grid2grid_mrms/GridStat_fcstCAM_obsMRMS_REFC.conf /gpfs/dell2/emc/verification/save/Logan.Dawson/CAM_verif/parm/use_cases/METplus-3.0/grid2grid_mrms/FV3SAR.conf
